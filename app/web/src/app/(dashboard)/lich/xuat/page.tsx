...
const formats: { key: ExportFormat; label: string; desc: string; icon: React.ReactNode; color: string }[] = [
  ...
  },
  {
    ...
    color: "bg-error-container/30 border-error/30",
  },
];
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-end gap-3">
        ...
        <button className="px-6 py-2.5 bg-primary text-on-primary rounded-xl font-medium text-sm hover:bg-primary/90 transition-colors flex items-center gap-2">
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
