    ...
    <div className="space-y-4">
      ...
      >
        <label className="text-sm">
          <span className="block text-xs text-on-surface-variant mb-1">Tìm kiếm</span>
          <input
            value={searchInput}
        ...
        <label className="text-sm">
          <span className="block text-xs text-on-surface-variant mb-1">Role</span>
          <select
            value={role}
            onChange={(e) => {
              setPage(1);
        ...
        <label className="text-sm">
          <span className="block text-xs text-on-surface-variant mb-1">Khoá</span>
          <select
            value={locked}
            onChange={(e) => {
              setPage(1);
          ...
          <tbody>
            {items.map((u) => (
              <tr key={u.user_id} className="border-t border-outline-variant">
                ...
                <td className="px-3 py-2">
                  {u.is_locked ? (
                    <span className="text-on-tertiary-container text-xs">🔒 Locked</span>
                  ) : (
