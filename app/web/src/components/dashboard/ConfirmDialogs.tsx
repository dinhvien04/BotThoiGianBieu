  ...
  return (
    <DialogOverlay isOpen={isOpen} onCancel={onCancel}>
      ...
      <div className="flex items-center justify-end gap-3">
        ...
        <button
          onClick={onConfirm}
          className="px-6 py-2.5 bg-error text-white rounded-xl font-medium text-sm hover:bg-error/90 transition-colors flex items-center gap-2"
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  return (
    <DialogOverlay isOpen={isOpen} onCancel={onCancel}>
      ...
      <div className="flex items-center justify-end gap-3">
        ...
        <button
          onClick={onConfirm}
          className="px-6 py-2.5 bg-error text-white rounded-xl font-medium text-sm hover:bg-error/90 transition-colors uppercase tracking-wide"
        >
          Xóa thẻ
        </button>
      </div>
  ...
  return (
    <DialogOverlay isOpen={isOpen} onCancel={onCancel}>
      ...
      <div className="flex items-center justify-end gap-3">
        ...
        <button
          onClick={onConfirm}
          className="px-5 py-2.5 bg-error text-white rounded-xl font-medium text-sm hover:bg-error/90 transition-colors flex items-center gap-2"
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" />
          </svg>
