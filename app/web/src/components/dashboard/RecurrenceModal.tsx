      ...
      <div className="relative bg-white rounded-2xl w-full max-w-md shadow-xl">
        <div className="flex items-center justify-between p-5 border-b border-surface-container-high">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg font-bold text-on-surface">Cài đặt lịch lặp</h2>
          </div>
        ...
        <div className="p-5 space-y-5">
          {/* Event Name */}
          <div>
            <p className="text-xs font-semibold text-on-surface-variant uppercase tracking-wider mb-1.5">Sự kiện</p>
            <div className="flex items-center gap-3 px-4 py-3 bg-surface-container-low rounded-xl">
              ...
              <span className="text-sm font-medium text-on-surface">{eventTitle}</span>
            </div>
          </div>

          {/* Frequency */}
          <div>
            <p className="text-xs font-semibold text-on-surface-variant uppercase tracking-wider mb-2">Tần suất</p>
